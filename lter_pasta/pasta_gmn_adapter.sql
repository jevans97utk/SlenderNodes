...
drop table if exists adapter_population_queue_status cascade;
...
---- adapter_population_queue_status
--
--CREATE TABLE adapter_population_queue_status (
--    id integer NOT NULL,
--    status character varying(128) NOT NULL
--);
--
--ALTER TABLE public.adapter_population_queue_status OWNER TO pasta_gmn_adapter;
--
--CREATE SEQUENCE adapter_population_queue_status_id_seq
--    START WITH 1
--    INCREMENT BY 1
--    NO MAXVALUE
--    NO MINVALUE
--    CACHE 1;
--
--ALTER TABLE public.adapter_population_queue_status_id_seq OWNER TO pasta_gmn_adapter;
--
--ALTER SEQUENCE adapter_population_queue_status_id_seq OWNED BY adapter_population_queue_status.id;
--
--SELECT pg_catalog.setval('adapter_population_queue_status_id_seq', 1, true);
...
--ALTER TABLE ONLY adapter_population_queue_status ALTER COLUMN id SET DEFAULT nextval('adapter_population_queue_status_id_seq'::regclass);
...
--ALTER TABLE ONLY adapter_population_queue_status
--    ADD CONSTRAINT adapter_population_queue_status_pkey PRIMARY KEY (id);

--ALTER TABLE ONLY adapter_population_queue_status
--    ADD CONSTRAINT adapter_population_queue_status_status_key UNIQUE (status);
...
--ALTER TABLE ONLY adapter_population_queue
--    ADD CONSTRAINT adapter_population_queue_status_id_fkey FOREIGN KEY (status_id) REFERENCES adapter_population_queue_status(id) DEFERRABLE INITIALLY DEFERRED;
...
--CREATE INDEX adapter_population_queue_status_id ON adapter_population_queue USING btree (status_id);
...
--CREATE INDEX adapter_process_status_n_failed_attempts ON adapter_process_status USING btree (n_failed_attempts);
